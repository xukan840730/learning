...
def get_CIFAR10_data(num_training=10000, num_empty= 39000, num_validation=1000, num_test=1000, num_dev=500):
    """
    ...
    X_dev = np.reshape(X_dev, (X_dev.shape[0], -1)).astype('float32')
