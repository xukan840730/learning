...
namespace OrbisAnim
{
	namespace CommandBlock
	{
		...
		void ExecuteCommandMultFloat(DispatcherFunctionArgs_arg_const param_qw0, LocationMemoryMap_arg_const memoryMap, OrbisAnim::SegmentContext* /*pSegmentContext*/)
		{
			...
			const MultFloatsParams* pParams = (const MultFloatsParams*)OrbisAnim::CommandBlock::LocationToPointer(((uint32_t)param_qw0[4] << 16) | (uint32_t)param_qw0[3], memoryMap);
			const MultFloatsParams::Entry* pEntries = (const MultFloatsParams::Entry*)(pParams + 1);
