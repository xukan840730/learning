...
{
	boxId = groupIndex.x;
	gridIdX = groupThread.x;
	gridIdZ = groupThread.y;
}

// This appears to be unused
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreeEvaluate( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreeBase( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreePass1( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreePass2( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreePass3( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreeMotionVectorPass1( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreeMotionVectorPass2( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreeMotionVectorPass3( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreeBaseHeightmap( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
...
[numthreads(kMaxThreadX, kMaxThreadY, kMaxThreadZ)]
void Cs_QuadTreeDebug( uint3 groupIndex : SV_GroupID,  uint3 groupThread : SV_GroupThreadId,  SrtData srt : S_SRT_DATA)
{
	int boxId, gridIdX, gridIdZ;
	GetBoxCoordinates(groupIndex, groupThread, boxId, gridIdX, gridIdZ);
